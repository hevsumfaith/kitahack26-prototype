...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle": "The Right Stream",
    "hero.desc": "StreamWise uses AI to help you choose your Form 4 academic stream based on your unique interests and strengths, not just your exam results.",
    "hero.cta": "Take Assessment",
    "hero.explore": "Explore Streams",
    "hero.badge": "Empowering Form 3 Students",
    "features.title": "How StreamWise Helps You",
    ...
    "footer.rights": "© 2024 StreamWise Malaysia. Supporting SDG 4: Quality Education.",
    "footer.privacy": "Privacy Policy",
    "footer.terms": "Terms of Service",
    "assessment.step": "Assessment Step",
    "assessment.complete": "Assessment Complete",
    "assessment.welcome": "Welcome to StreamWise Assessment",
    ...
    "streams.noteDesc": "While StreamWise helps match your interest and potential, schools still look at your PBD (Pentaksiran Bilik Darjah) results and teacher recommendations for final placement.",
  ...
  ms: {
    ...
    "hero.subtitle": "Aliran yang Tepat",
    "hero.desc": "StreamWise menggunakan AI untuk membantu anda memilih aliran akademik Tingkatan 4 berdasarkan minat dan kekuatan unik anda, bukan sekadar keputusan peperiksaan.",
    "hero.cta": "Ambil Penilaian",
    "hero.explore": "Teroka Aliran",
    "hero.badge": "Memperkasa Pelajar Tingkatan 3",
    "features.title": "Bagaimana StreamWise Membantu Anda",
    ...
    "footer.rights": "© 2024 StreamWise Malaysia. Menyokong SDG 4: Pendidikan Berkualiti.",
    ...
    "assessment.welcome": "Selamat Datang ke Penilaian StreamWise",
    ...
    "streams.noteDesc": "Walaupun StreamWise membantu memadankan minat dan potensi anda, pihak sekolah masih melihat keputusan PBD (Pentaksiran Bilik Darjah) dan syor guru untuk penempatan akhir.",
